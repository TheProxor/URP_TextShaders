...
{
    public abstract class BaseShaderGUIOverride : ShaderGUI
    {
        ...
        protected class Styles
        {
            ...
            public static readonly GUIContent otherOptions = new GUIContent("Your own options", 
                "You own custom options");
        }
        ...
        UnityEditor.AnimatedValues.AnimBool m_SurfaceOptionsFoldout;

        UnityEditor.AnimatedValues.AnimBool m_SurfaceInputsFoldout;

        UnityEditor.AnimatedValues.AnimBool m_AdvancedFoldout;

        UnityEditor.AnimatedValues.AnimBool m_OtherFoldout;
